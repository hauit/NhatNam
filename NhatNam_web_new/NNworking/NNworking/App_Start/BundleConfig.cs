...
namespace NNworking {
    ...
    public class BundleConfig {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jquery")
                .Include("~/Scripts/adminlte/newJS/jquery.min.js")
                .Include("~/Scripts/adminlte/newJS/bootstrap.min.js")
                .Include("~/Scripts/adminlte/newJS/adminlte.min.js"));

            bundles.Add(new ScriptBundle("~/bundles/lib")
                //.Include(ltecomponents + "jquery-ui/jquery-ui.min.js")
                .Include(ltecomponents + "jquery-ui/jquery-1.12.1.min.js")
