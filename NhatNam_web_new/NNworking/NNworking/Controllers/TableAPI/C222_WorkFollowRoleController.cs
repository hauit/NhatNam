...
{
    [Route("api/C222_WorkFolowRole/{action}", Name = "C222_WorkFolowRoleApi")]
    public class C222_WorkFolowRoleController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get(DataSourceLoadOptions loadOptions) {
            ...
            return Request.CreateResponse(await DataSourceLoader.LoadAsync(c222_WorkFolowrole, loadOptions));
        }
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form) {
            ...
            var result = _context.C222_WorkFolowRole.Add(model);
        ...
        public async Task Delete(FormDataCollection form) {
            ...
            _context.C222_WorkFolowRole.Remove(model);
            await _context.SaveChangesAsync();
        }
