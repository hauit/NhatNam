...
{
    [Route("api/C222_TimeCardDetail/{action}", Name = "C222_TimeCardDetailApi")]
    public class C222_TimeCardDetailController : ApiController
    {
        ...
        public HttpResponseMessage Get(DataSourceLoadOptions loadOptions) {
            ...
            return Request.CreateResponse(DataSourceLoader.Load(c222_timecarddetail, loadOptions));
        }
        ...
        public HttpResponseMessage Post(FormDataCollection form) {
            ...
            var result = _context.C222_TimeCardDetail.Add(model);
        ...
        public void Delete(FormDataCollection form) {
            ...
            _context.C222_TimeCardDetail.Remove(model);
            _context.SaveChanges();
        }
        ...
        private void PopulateModel(C222_TimeCardDetail model, IDictionary values) {
            ...
            string IN_TIME = nameof(C222_TimeCardDetail.InTime);
