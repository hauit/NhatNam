...
{
    [Route("api/C222_KaizenType/{action}", Name = "C222_KaizenTypeApi")]
    public class C222_KaizenTypeController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Get(DataSourceLoadOptions loadOptions)
        {
            ...
            return Request.CreateResponse(await DataSourceLoader.LoadAsync(c222_kaizentype, loadOptions));
        }
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form)
        {
            ...
            var result = _context.C222_KaizenType.Add(model);
        ...
        public async Task Delete(FormDataCollection form)
        {
            ...
            _context.C222_KaizenType.Remove(model);
            await _context.SaveChangesAsync();
        }
